    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label>
                    Data:
                    <input type="text" name="date" value={event.date} onChange={handleChange} />
                </label>
                <br />
                <label>
                    Horário:
                ...
                <label>
                    URL da imagem:
                    <input type="text" name="image_url" value={event.image_url} onChange={handleChange} />
                </label>
                <br />
                <label>
                    Evento privado:
                    <input type="checkbox" name="private_event" checked={event.private_event} onChange={handleChange} />
                </label>
                <br />
